...
def py2_miller_min_left(start_date=BITE_CREATED_DT):
    ...
    # 1 Miller hours = 7 Earth years [no leap years assumed]
    #   i.e. 3600 seconds Earth time =
    #        60 minutes * 24 hours * 365 days * 7 years
    miller_hour = (60 * 24 * 365) * 7
    duration = PY2_DEATH_DT - start_date
    return round(duration.total_seconds() / miller_hour, 2)


print(BITE_CREATED_DT, PY2_DEATH_DT)
