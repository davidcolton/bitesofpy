...
def create_parser():
    ...
    parser = argparse.ArgumentParser(prog='bmi.py',
                                     description='Calculate your BMI.')
                                     
    parser.add_argument("-w", "--weight", help="Your weight in kg", type=int)
    parser.add_argument("-l", "--length", help="Your length in cm", type=int)
